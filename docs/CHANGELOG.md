...
- [[1.0.20] - 2025-02-18](#1020-2025-02-18)
  - [Fixed](#fixed-3)
  - [Changed](#changed-15)
- [[1.0.19] - 2026-03-02](#1019-2026-03-02)
  - [Fixed](#fixed-4)
  - [Changed](#changed-16)
- [[1.0.18] - 2026-03-02](#1018-2026-03-02)
  - [Changed](#changed-17)
  - [Removed](#removed-2)
- [[1.0.17] - 2026-02-18](#1017-2026-02-18)
  - [Fixed](#fixed-5)
  - [Changed](#changed-18)
- [[1.0.16] - 2026-02-18](#1016-2026-02-18)
  - [Changed](#changed-19)
- [[1.0.15] - 2026-02-18](#1015-2026-02-18)
  - [Added](#added-9)
  - [Changed](#changed-20)
- [[1.0.14] - 2026-02-18](#1014-2026-02-18)
  - [Changed](#changed-21)
- [[1.0.13] - 2026-02-18](#1013-2026-02-18)
  - [Fixed](#fixed-6)
  - [Changed](#changed-22)
- [[1.0.12] - 2026-02-11](#1012-2026-02-11)
  - [Added](#added-10)
  - [Changed](#changed-23)
- [[1.0.11] - 2026-02-10](#1011-2026-02-10)
  - [Added](#added-11)
  - [Changed](#changed-24)
- [[1.0.10] - 2025-02-10](#1010-2025-02-10)
  - [Added](#added-12)
  - [Fixed](#fixed-7)
  - [Changed](#changed-25)
- [[1.0.9] - 2025-01-26](#109-2025-01-26)
  - [Fixed](#fixed-8)
- [[1.0.8] - 2024-12-15](#108-2024-12-15)
  - [Changed](#changed-26)
- [[1.0.7] - 2024-12-15](#107-2024-12-15)
  - [Changed](#changed-27)
  - [Fixed](#fixed-9)
- [[1.0.6] - 2024-12-15](#106-2024-12-15)
  - [Changed](#changed-28)
- [[1.0.5] - 2024-12-15](#105-2024-12-15)
  - [Fixed](#fixed-10)
- [[1.0.4] - 2024-12-15](#104-2024-12-15)
  - [Fixed](#fixed-11)
- [[1.0.3] - 2024-12-15](#103-2024-12-15)
  - [Added](#added-13)
  - [Changed](#changed-29)
- [[1.0.2] - 2024-12-12](#102-2024-12-12)
  - [Fixed](#fixed-12)
  - [Changed](#changed-30)
- [[1.0.1] - 2024-12-12](#101-2024-12-12)
  - [Changed](#changed-31)
- [[0.0.1] - 2024-12-12](#001-2024-12-12)
  - [Added](#added-14)
  - [Fixed](#fixed-13)
  - [Changed](#changed-32)
...
[1.1.4]: https://github.com/nowo-tech/TwigInspectorBundle/releases/tag/v1.1.4
...
[1.1.2]: https://github.com/nowo-tech/TwigInspectorBundle/releases/tag/v1.1.2
...
- **REQ-CS-005**: `nowo-tech/phpstan-frankenphp` as `require-dev` with `ruleset-classic.neon` + `ruleset-worker.neon` in `phpstan.neon.dist` (package source analysis only; not a runtime dependency for consumers).
- **REQ-MAKE-007**: `make down-dev` (alias of `down --remove-orphans`).

### Changed

- **PHPStan**: Renamed root config from `phpstan.neon` to `phpstan.neon.dist`; DNS `8.8.8.8` / `8.8.4.4` on root Compose for reliable Packagist resolution.
- **InstallCommand**: Replaced process-wide `set_error_handler` with `@file_get_contents` when reading `routes.yaml` (FrankenPHP worker-safe, FPM-compatible).
- **NowoTwigInspectorExtension**: Validate `kernel.environment` is a string before use (PHPStan `cast.string`).
- **Docs**: CONTRIBUTING / DEVELOPMENT mention FrankenPHP PHPStan rulesets; README PHP coverage percentage refreshed (99.70%).
...
- **Hard-fail outside `dev`/`test`**: `NowoTwigInspectorExtension` throws `LogicException` when `kernel.environment` is not allowed (fail-closed for prod and other envs).
- **Env gate on injectors**: `HtmlCommentsExtension` and `ControllerCommentSubscriber` require an allowed environment **in addition to** `kernel.debug` (blocks `prod` + `APP_DEBUG=1`).
- **Install command**: `nowo:twig-inspector:install` refuses non-dev/test `--env` values.
- **Shared helper**: New `DevEnvironments` class centralizes the allowed-env list for DI, injectors, IDE controller, and CLI.

### Added

- **Documentation**: Threat model in `docs/SECURITY.md`; README NO-PROD callout; Flex recipe `post-install.txt` warning; INSTALLATION notes for hard-fail behavior.
- **Tests**: Coverage for prod rejection (extension, install, injectors with `debug=true`), plus `DevEnvironmentsTest`.

### Changed

- **`OpenTemplateController`**: Uses `DevEnvironments::isAllowed()` (same allowed list as the rest of the bundle).
- **`composer.json` suggest**: Clarifies Flex registers the bundle for dev/test only and install must use `--dev`.
- **Demos**: Path-bundle lockfile references refreshed to the release commit.
...
- **Demo Docker Compose (Symfony 6/7/8)**: Added explicit `dns` resolvers (`8.8.8.8`, `8.8.4.4`) in demo `docker-compose.yml` files to mitigate Docker/WSL DNS failures resolving `repo.packagist.org` during Composer operations.
- **Dependencies**: Updated Symfony polyfills in root and demo lockfiles to latest compatible patch versions.
- **Symfony 8 demo config**: Removed unnecessary `declare(strict_types=1);` from `demo/symfony8/config/reference.php`.

### Fixed

- **GitHub release automation**: `release.yml` now uses per-tag concurrency, pins `softprops/action-gh-release` to `v2.3.4`, and disables generated notes to avoid release finalization races.
- **Release sync workflow**: `sync-releases.yml` no longer triggers on tag push, preventing race conditions with the release workflow.
- **Scrutinizer compatibility**: `.scrutinizer.yml` stays on Node 16 and runs only PHP coverage in Scrutinizer workers (frontend Vitest/pnpm remains in GitHub Actions) due to `GLIBC_2.28` limitations on Scrutinizer infrastructure.
