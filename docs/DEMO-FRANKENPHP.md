...
The bundle itself is audited for FrankenPHP **worker mode with the kernel not reset between requests** (strict scenario B). See [`FRANKENPHP-WORKER-AUDIT.md`](FRANKENPHP-WORKER-AUDIT.md).
