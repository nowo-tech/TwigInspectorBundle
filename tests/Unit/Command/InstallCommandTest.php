...
final class InstallCommandTest extends TestCase
{
     ...
     * and when SymfonyStyle adds block borders (" ! ") on wrapped lines.
     */
    ...
    /**
     * Covers ensureRoutesFile when routes path is invalid (e.g. directory).
     * Either file_get_contents() returns false ("Could not read") or later appendToFile() throws ("Could not update").
     */
    ...
    /**
     * Covers ensureRoutesFile when file_get_contents returns false using a stream wrapper.
     * The wrapper makes exists() true but stream_open fail so file_get_contents returns false.
     */
    public function testEnsureRoutesFileWhenStreamWrapperFailsReadShowsCouldNotReadWarning(): void
    {
        InstallCommandReadFailStreamWrapper::register();
        try {
            $routesPath = 'installreadfail://dummy';
            ...
            InstallCommandReadFailStreamWrapper::unregister();
        }
    }
