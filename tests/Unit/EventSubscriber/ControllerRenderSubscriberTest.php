...
final class ControllerRenderSubscriberTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subscriber   = new ControllerRenderSubscriber(new RequestStackMainOrMasterAdapter($this->requestStack));
    }
    ...
    public function testOnControllerWhenMainRequestIsNullUsesRequestAsMaster(): void
    {
        ...
        $subscriber = new ControllerRenderSubscriber(new RequestStackMainOrMasterAdapter($requestStack));
        $request    = new Request();
        $kernel     = $this->createMock(HttpKernelInterface::class);
        $event      = new ControllerEvent($kernel, static fn () => null, $request, HttpKernelInterface::MAIN_REQUEST);
    ...
    {
        $subscriber = new ControllerRenderSubscriber(new RequestStackMainOrMasterAdapter(new RequestStack()));
     ...
     */
    public function testOnControllerRecordsControllerWhenProviderUsesGetMasterRequestOnly(): void
    {
        $request    = new Request();
        $legacyStub = new LegacyRequestStackStub($request, $request);
        $provider   = new RequestStackMainOrMasterAdapter($legacyStub);
        $subscriber = new ControllerRenderSubscriber($provider);
