...
class DemoController extends AbstractController
{
    ...
    public function home(): Response
    {
        return $this->render('demo/home.html.twig', [
            ...
            'message' => 'This is a demo page to showcase the Twig Inspector Bundle functionality with Symfony 6.4.',
            'version_badge' => 'Symfony 6.4',
            'subtitle' => 'Symfony Bundle Demo',
            'sy_version' => 'Symfony 6.4',
            'items' => [
                ...
                'Use the filter (e.g. header, footer, instructions) to highlight only those templates',
