...
final class DemoControllerTest extends WebTestCase
{
    ...
    public function testHomePageContainsSymfonyVersion(): void
    {
        ...
        $this->assertResponseIsSuccessful();
        $this->assertSelectorTextContains('.version-badge', 'Symfony 7.0');
    }
    ...
    public function testHomePageRendersMessage(): void
    {
        ...
        $this->assertResponseIsSuccessful();
        $this->assertSelectorTextContains('h2 + p', 'showcase the Twig Inspector Bundle functionality with Symfony 7.0');
    }
