 ...
 *     excluded_templates_prefixes?: list<scalar|null>,
 *     excluded_blocks_regex?: list<scalar|null>,
 *     overlay_theme?: scalar|null, // Overlay theme: "light", "dark", or "auto" (follow system preference). // Default: "light"
 *     overlay_compact?: bool, // Use compact tooltip style for the overlay. // Default: false
 *     reduced_motion?: bool, // Respect reduced motion (accessibility). When true or system prefers-reduced-motion, animations are minimized. // Default: false
 *     keyboard_shortcut?: scalar|null, // Keyboard shortcut to toggle inspector (e.g. "Ctrl+Shift+T"). Empty to disable. // Default: "Ctrl+Shift+T"
 * }
